...
<!-- Full-width images with number and caption text -->
    <div class="mySlides">
      ...
      <img src="<?php echo base_url(); ?>asset/img/ukm/5.jpg" style="width:100%">
      <div class="text">Timeline</div>
    </div>

    <div class="mySlides">
      <div class="numbertext">2 / 3</div>
      <img src="<?php echo base_url(); ?>asset/img/ukm/6.jpg" style="width:100%">
      <div class="text">Relax & Easy</div>
    </div>

    <div class="mySlides">
      <div class="numbertext">3 / 3</div>
      <img src="<?php echo base_url(); ?>asset/img/ukm/7.jpg" style="width:100%">
                            ...
                            <div class="blog_post">
                                ...
                                <div class="blog_details">
                                    <a href="single-blog.html">
                                        <h2>Perpustakaan dan UKM Literasi Menandatangani MOU dengan Turky</h2>
                                    </a>
