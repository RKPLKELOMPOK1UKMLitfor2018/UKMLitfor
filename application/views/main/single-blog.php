                            ...
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    ...
                                    <div class="desc">
                                        ...
                                        <p class="date">Februari 26, 2019 3:12 pm </p>
                                        <p class="comment">
                                            wow!!
                                        </p>
                                    </div>
                            ...
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    ...
                                    <div class="desc">
                                        ...
                                        <p class="date">Februari 26, 2019 at 3:12 pm </p>
                                        <p class="comment">
                                            keren...
                                        </p>
                                    </div>
                            ...
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    ...
                                    <div class="desc">
                                        ...
                                        <p class="date">Februari 27, 2019 at 3:12 pm </p>
                                        <p class="comment">
                                            mantap...
                                        </p>
                                    </div>
                        ...
                        <form>
                            <div class="form-group form-inline">
                                <div class="form-group col-lg-6 col-md-6 name">
                                    <input type="text" class="form-control" id="name" placeholder="Nama" onfocus="this.placeholder = ''"
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="subject" placeholder="Judul" onfocus="this.placeholder = ''"
                                    onblur="this.placeholder = 'Judul'">
                            </div>
                            <div class="form-group">
                            ...
                            <a href="#" class="primary-btn">Kirim Komentar</a>
                        </form>
                    </div>
                </div>
                <div class="col-lg-4">
